...
local function resetBrakeTemp()
    if isInitialized and textureHandle then
        ...
        electrics.values.brakeTempFL = DEFAULT_TEMP
    end
end
...
local function updateGFX(dt)
    ...
    if timeSinceLastUpdate >= updateInterval then
        ...
        if electrics and electrics.values and electrics.values.wheelThermals then
            ...
            if wheelThermals.FL and wheelThermals.FL.brakeSurfaceTemperature then
                brakeTemp = wheelThermals.FL.brakeSurfaceTemperature
            elseif wheelThermals.FL1 and wheelThermals.FL1.brakeSurfaceTemperature then
                brakeTemp = wheelThermals.FL1.brakeSurfaceTemperature
            end
        end
        ...
        if textureHandle then
            ...
            electrics.values.brakeTempFL = brakeTemp
        end
