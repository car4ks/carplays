...
local function resetBrakeTemp()
    if isInitialized and textureHandle then
        ...
        electrics.values.brakeTempFR = DEFAULT_TEMP
    end
end
...
local function updateGFX(dt)
    ...
    if timeSinceLastUpdate >= updateInterval then
        ...
        if electrics and electrics.values and electrics.values.wheelThermals then
            ...
            if wheelThermals.FR and wheelThermals.FR.brakeSurfaceTemperature then
                brakeTemp = wheelThermals.FR.brakeSurfaceTemperature
            elseif wheelThermals.FR1 and wheelThermals.FR1.brakeSurfaceTemperature then
                brakeTemp = wheelThermals.FR1.brakeSurfaceTemperature
            end
        end
        ...
        if textureHandle then
            ...
            electrics.values.brakeTempFR = brakeTemp
        end
